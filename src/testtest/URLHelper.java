...
public class URLHelper {
        ...
        try {
            ...
            if (totalResults > 0) {
                ...
                resultMenu += template + template + template
                        + "********************************************\n\nSelection> ";
                varitems.addAll(new ArrayList<>(
                        Arrays.asList(new String[] { String.valueOf(totalResults + 1), "Search a different movie" })));
                varitems.addAll(new ArrayList<>(Arrays
                        .asList(new String[] { String.valueOf(totalResults + 3), "Print JSON format of results" })));
    ...
    public void resetMenuOptions() {
        ...
        resultMenu += "********************************************\n\nSelection> ";
        vars = new String[] { String.valueOf(results.size() + 1), "Search for another movie",
                String.valueOf(results.size() + 2), "Select another movie from results", "0", "Exit Program" };
    }
}